...
// كتابة ذرّية (ملف مؤقت + rename) مع نسخة احتياطية قبل الاستبدال - نفس السبب الموجود في sentTracker.js
function save(entries) {
  ...
  if (fs.existsSync(LOG_FILE)) {
    try {
      ...
      // فشل أخذ النسخة الاحتياطية مش سبب كافي نوقف الحفظ نفسه
    }
  }
...
module.exports = { logSend, getDaySummary, getAllByLabel, getLabelCounts, getAllRecipients };
